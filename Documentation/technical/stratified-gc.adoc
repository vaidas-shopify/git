...
geometric merge. If no surviving anchor has any base-stratum pack of
its own, no kept pack exists whose closure could be broken, so the
orphan can simply be demoted (the historical behavior).
